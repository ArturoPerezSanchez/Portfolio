    ...
    <section className="relative w-full h-screen mx-auto">
      <div className={`${styles.paddingX} absolute inset-0 top-[120px] max-w-7xl mx-auto flex flex-row items-start`}>
        ...
        <div className='flex flex-col gap-4'>
          ...
          <p className={`${styles.heroSubText} mt-2 text-white-100 p-2`}>I am <span className="text-[#915eff]">Arturo,</span> a software engineer <br className='sm:block hidden'/> driven by the realms of Web Development and AI. </p>
      ...
      {isDesktop ? (
        ...
        <div className={`absolute bottom-14 w-full flex justify-end items-center ${scrollElementClass}`} style={{ transition: 'opacity 0.5s' }}>
