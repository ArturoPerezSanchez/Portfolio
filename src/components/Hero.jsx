...
const Hero = () => {
  const isDesktop = useMediaQuery({ minWidth: 640 }); // Define the minimum width to consider the device as desktop
  return (
    <section className="relative w-full h-screen mx-auto">
      ...
      { (isDesktop) ? <ComputersCanvas /> :  <div className='absolute bottom-14 w-full flex justify-center items-center'>
        <a href="#about">
